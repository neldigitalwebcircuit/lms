...
body, html {
    ...
    background-image: linear-gradient(rgb(104, 145, 132), rgb(12, 97, 97));
    ...
    <div class="container">
        <div class="card card-container">
            ...
            <form class="form-signin" method="POST" action="<?= site_url('auth') ?>">
                ...
                <button id="login" class="btn btn-lg btn-primary btn-block btn-signin" type="submit"> <span class="glyphicon glyphicon-log-in"></span>  Sign in</button>
            </form><!-- /form -->
